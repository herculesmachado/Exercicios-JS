...
console.log('3' - 2) //Neste caso acontece a subtração, pois diferente da operação de cima, o JS entende que o MENOS não faz sentido no mundo das String, coisa que com o + (MAIS) sim devido a sua concatenação