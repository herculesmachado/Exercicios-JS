...
console.log(a.substring(0, 5)) //Ele mostra da letra 0 ate a letra 5

console.log('Statess '.concat(a).concat(' !')) //Junta todas strings 
console.log('Statess ' + a + " !") // Faz a mesma função do .concat 

console.log(a.replace(3, 'o')) //Na palavra se tiver algum numero e voce quiser mudar pra uma letra, basta fazer esse ex: de replace

console.log('Maria,Pedro,João'.split(',')) //Da um espaçamento entre os nomes
